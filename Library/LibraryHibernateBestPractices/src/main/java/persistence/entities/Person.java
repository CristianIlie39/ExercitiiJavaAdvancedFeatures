...
@NamedQueries({
        ...
        @NamedQuery(name = "deletePersonBySurname", query = "delete from persistence.entities.Person person where person.surname = :surname"),
        @NamedQuery(name = "updatePersonBySurname", query = "update from persistence.entities.Person person set person.address = :address where person.surname = :surname")
})
