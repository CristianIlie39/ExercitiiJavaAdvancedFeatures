...
@NamedQueries({
        ...
        @NamedQuery(name = "deleteBookByTitle", query = "delete from persistence.entities.Book where title = :title"),
        @NamedQuery(name = "updateBookByTitle", query = "update from persistence.entities.Book book set book.borrowed = :borrowed where book.title = :title"),
        @NamedQuery(name = "countBookByTitle", query = "select count(*) from Book book where book.title = :title")
})
