...
public class BookService {
    ...
    public Integer deleteBookByTitle(String title) {
        Integer numberOfBooksDeleted = bookDAO.deleteBookByTitle(title);
    ...
    public Long countBookByTitle(String title) {
        Long numberOfBooksByTitle = bookDAO.countBookByTitle(title);
        return numberOfBooksByTitle;
    }

    public Integer updateBookByTitle(String title, boolean borrowed) {
        Integer numberOfBooksUpdated = bookDAO.updateBookByTitle(title, borrowed);
